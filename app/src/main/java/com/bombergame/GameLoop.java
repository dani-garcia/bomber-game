...
public class GameLoop extends Thread {
    ...
    public void run() {
        try {
            ...
            long tiempoAlInicio; // Tiempo inicio del ciclo
            long tiempoDiferencial; // Tiempo que tarda el ciclo desde su inicio al fin
            int tiempoEspera; // Espera entre ejecuciones
            int framesSaltados; // Numero de frames que se han saltado
