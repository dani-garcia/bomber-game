...
public class MejoraExplotarDistancia extends AbstractMejora {
    public MejoraExplotarDistancia(Context context, double x, double y) {
        super(context, x, y);
        tipo = AbstractMejora.EXPLOSION_DISTANCIA;
    }
    ...
    public void mejorar(Jugador jugador) {
        jugador.buffoExplosionDistanciaBombas = true;
    }
}
